...
public final class ReferenceServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.MenuRequest,
      ru.bmstu.iu3.grpc.MenuResponse> getGetMenuMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMenu",
      requestType = ru.bmstu.iu3.grpc.MenuRequest.class,
      responseType = ru.bmstu.iu3.grpc.MenuResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.MenuRequest,
      ru.bmstu.iu3.grpc.MenuResponse> getGetMenuMethod() {
    io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.MenuRequest, ru.bmstu.iu3.grpc.MenuResponse> getGetMenuMethod;
    if ((getGetMenuMethod = ReferenceServiceGrpc.getGetMenuMethod) == null) {
      synchronized (ReferenceServiceGrpc.class) {
        if ((getGetMenuMethod = ReferenceServiceGrpc.getGetMenuMethod) == null) {
          ReferenceServiceGrpc.getGetMenuMethod = getGetMenuMethod =
              io.grpc.MethodDescriptor.<ru.bmstu.iu3.grpc.MenuRequest, ru.bmstu.iu3.grpc.MenuResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetMenu"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.bmstu.iu3.grpc.MenuRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.bmstu.iu3.grpc.MenuResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ReferenceServiceMethodDescriptorSupplier("GetMenu"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.DishRequest,
      ru.bmstu.iu3.grpc.DishResponse> getGetDishByNumberMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDishByNumber",
      requestType = ru.bmstu.iu3.grpc.DishRequest.class,
      responseType = ru.bmstu.iu3.grpc.DishResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.DishRequest,
      ru.bmstu.iu3.grpc.DishResponse> getGetDishByNumberMethod() {
    io.grpc.MethodDescriptor<ru.bmstu.iu3.grpc.DishRequest, ru.bmstu.iu3.grpc.DishResponse> getGetDishByNumberMethod;
    if ((getGetDishByNumberMethod = ReferenceServiceGrpc.getGetDishByNumberMethod) == null) {
      synchronized (ReferenceServiceGrpc.class) {
        if ((getGetDishByNumberMethod = ReferenceServiceGrpc.getGetDishByNumberMethod) == null) {
          ReferenceServiceGrpc.getGetDishByNumberMethod = getGetDishByNumberMethod =
              io.grpc.MethodDescriptor.<ru.bmstu.iu3.grpc.DishRequest, ru.bmstu.iu3.grpc.DishResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDishByNumber"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.bmstu.iu3.grpc.DishRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.bmstu.iu3.grpc.DishResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ReferenceServiceMethodDescriptorSupplier("GetDishByNumber"))
              .build();
        }
      }
    }
    return getGetDishByNumberMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getMenu(ru.bmstu.iu3.grpc.MenuRequest request,
        io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.MenuResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetMenuMethod(), responseObserver);
    }

    /**
     */
    default void getDishByNumber(ru.bmstu.iu3.grpc.DishRequest request,
        io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.DishResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDishByNumberMethod(), responseObserver);
    }
  }
  ...
  public static final class ReferenceServiceStub
    ...
    /**
     */
    public void getMenu(ru.bmstu.iu3.grpc.MenuRequest request,
        io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.MenuResponse> responseObserver) {
    ...
    /**
     */
    public void getDishByNumber(ru.bmstu.iu3.grpc.DishRequest request,
        io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.DishResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetDishByNumberMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ReferenceServiceBlockingStub
    ...
    /**
     */
    public ru.bmstu.iu3.grpc.MenuResponse getMenu(ru.bmstu.iu3.grpc.MenuRequest request) {
    ...
    /**
     */
    public ru.bmstu.iu3.grpc.DishResponse getDishByNumber(ru.bmstu.iu3.grpc.DishRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetDishByNumberMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ReferenceServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.bmstu.iu3.grpc.MenuResponse> getMenu(
        ru.bmstu.iu3.grpc.MenuRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.bmstu.iu3.grpc.DishResponse> getDishByNumber(
        ru.bmstu.iu3.grpc.DishRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetDishByNumberMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_MENU = 0;
  private static final int METHODID_GET_DISH_BY_NUMBER = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MENU:
          serviceImpl.getMenu((ru.bmstu.iu3.grpc.MenuRequest) request,
              (io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.MenuResponse>) responseObserver);
          break;
        case METHODID_GET_DISH_BY_NUMBER:
          serviceImpl.getDishByNumber((ru.bmstu.iu3.grpc.DishRequest) request,
              (io.grpc.stub.StreamObserver<ru.bmstu.iu3.grpc.DishResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ru.bmstu.iu3.grpc.MenuRequest,
              ru.bmstu.iu3.grpc.MenuResponse>(
                service, METHODID_GET_MENU)))
        .addMethod(
          getGetDishByNumberMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ru.bmstu.iu3.grpc.DishRequest,
              ru.bmstu.iu3.grpc.DishResponse>(
                service, METHODID_GET_DISH_BY_NUMBER)))
        .build();
  }
  ...
  private static abstract class ReferenceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.bmstu.iu3.grpc.ReferenceProto.getDescriptor();
    }
      ...
      synchronized (ReferenceServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetDishByNumberMethod())
              .build();
        }
      }
    }
